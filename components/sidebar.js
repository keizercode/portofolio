  ...
  return (
    ...
    >
      <div className='grid justify-items-center relative'>
        ...
        />
        <h1 className='text-xl font-bold text-center'>Luqman Abdur Rohim</h1>
          ...
          <ul>
            <li>
              <button
                ...
                className={`transition duration-200 ease-in-out ${
                  selectedItem == 'About' ? 'btn btn-blue' : 'btn'
                }`}
              >
                About
              </button>
            ...
            <li>
              <button
                ...
                className={`transition duration-200 ease-in-out ${
                  selectedItem == 'Skills' ? 'btn btn-blue' : 'btn'
                }`}
              >
                Skills
              </button>
            ...
            <li>
              <button
                ...
                className={`transition duration-200 ease-in-out ${
                  selectedItem == 'Projects' ? 'btn btn-blue' : 'btn'
                }`}
              >
                Projects
              </button>
            ...
            <li>
              <a
                ...
                href='https://drive.google.com/file/d/186XvonrnIrvyNd7jVBg831kRnJMpFEHt/view?usp=sharing'
                target='_blank'
              >
        ...
        <small className='mt-5 text-gray-500'>Made with &hearts; by Me</small>
        <div className='absolute top-0 right-0'>
          {isDark ? (
            <button onClick={() => selectTheme('light')}>
              <img className='w-6' src='./img/icon/sun-solid.svg' />
            </button>
          ) : (
            <button onClick={() => selectTheme('dark')}>
              <img className='w-6' src='./img/icon/moon-solid.svg' />
            </button>
          )}
        </div>
      </div>
